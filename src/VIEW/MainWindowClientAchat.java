...
public class MainWindowClientAchat extends JFrame
{
    ...
    private void setInitialState()
    {
        ...
        // S'assurer que clientIdField est toujours actif
    ...
    private void enableSearchControls(boolean enable)
    {
        ...
        clientIdField.setEnabled(enable);
    }
    ...
    private void handleClientValidation()
    {
        try
        {
            ...
            if (nom.isEmpty() || prenom.isEmpty() || numClient.isEmpty())
            {
    ...
    private void handleEmptyCart()
    {
        ...
        if (confirm == JOptionPane.YES_OPTION)
        {
            try
            {
                RequeteCancelCaddy reqCancelCaddy=new RequeteCancelCaddy(Integer.parseInt(clientId),MyCrypto.RecupereClePrivee());
    ...
    private void handlePayment()
    {
        ...
        if (confirm == JOptionPane.YES_OPTION)
        {
            ...
            try
            {
                ...
                //Payer le caddy
                RequetePayCaddy reqPayCaddy = new RequetePayCaddy(idClient, cardNumber, cardName, MyCrypto.RecupereClePrivee());
